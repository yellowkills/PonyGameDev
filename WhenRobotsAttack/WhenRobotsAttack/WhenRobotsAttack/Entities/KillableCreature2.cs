...
{
    public class KillableCreature2 : Entity2
    {
        ...
        // Default Constructor
        public KillableCreature2(GameManager game)
            : base(game)
        {
        ...
        // Initializes the this objects variables for spawning
        public void Spawn()
        {
            isDead = false;
            isRecovering = false;
        ...
        // These allows damage and healing to work on a timed basis
